...
using namespace CYW955913DoorLock::ResourceRanges;
...
public:
    ...
    CHIP_ERROR Init(chip::app::DataModel::Nullable<chip::app::Clusters::DoorLock::DlLockState> state,
                    CYW955913DoorLock::LockInitParams::LockParam lockParam);
    bool NextState();
...
private:
    ...
    static void TimerEventHandler(cy_timer_callback_arg_t arg);
    ...
    CYW955913DoorLock::LockInitParams::LockParam LockParams;
};
