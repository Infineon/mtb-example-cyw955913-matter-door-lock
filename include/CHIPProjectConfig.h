...
#define CHIP_DEVICE_CONFIG_DEVICE_PRODUCT_NAME "CYW955913 Lock"

/* The HardwareVersionString attribute of the Basic cluster. */
#define CHIP_DEVICE_CONFIG_DEFAULT_DEVICE_HARDWARE_VERSION_STRING "CYW955913"

/* The HardwareVersion attribute of the Basic cluster. */
#define CHIP_DEVICE_CONFIG_DEFAULT_DEVICE_HARDWARE_VERSION 55900
 ...
 */
#define CHIP_DEVICE_CONFIG_DEVICE_HARDWARE_VERSION 55900
 ...
 *
 * Maximum payload in a PacketBuffer. Must match size of TX packet payload.
 */
#define CHIP_SYSTEM_CONFIG_PACKETBUFFER_CAPACITY_MAX (1540)
#endif

#define CHIP_CONFIG_SHA256_CONTEXT_SIZE     (60 * sizeof(uint32_t))
 ...
 */
#define CHIP_DEVICE_CONFIG_WIFI_STATION_RECONNECT_INTERVAL 30000
